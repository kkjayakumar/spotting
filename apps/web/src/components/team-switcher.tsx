...
const ORG_BADGE_CLASS =
  "spotting-org-badge flex aspect-square size-8 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground shadow-sm ring-1 ring-white/20"

const ORG_BADGE_TEXT_CLASS =
  "spotting-org-badge-text font-bold text-sm uppercase tracking-wide text-sidebar-primary-foreground"
      ...
      <SidebarMenu>
        ...
        <SidebarMenuItem>
          ...
          <SidebarMenuButton className="cursor-default" size="lg">
            ...
            <div className={ORG_BADGE_CLASS}>

              <span className={ORG_BADGE_TEXT_CLASS}>
            ...
            <div className="grid flex-1 text-left text-sm leading-tight">
              ...
              <span className="truncate text-muted-foreground text-xs">
                ...
                {activeOrganization?.slug ?? "team workspace"}
