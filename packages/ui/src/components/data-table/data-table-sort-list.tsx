  ...
  return (
    ...
    >
        <Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
              ...
              >
                <Trash2 />
              </Button><SortableItemHandle
                className="border-input bg-background hover:bg-muted hover:text-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 size-8 shrink-0 rounded border"
              >
                <GripVertical />
              </SortableItemHandle>
    </SortableItem>
