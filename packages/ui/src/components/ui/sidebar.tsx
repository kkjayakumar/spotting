...
import { useIsMobile } from "@spotting/ui/hooks/use-mobile"
...
import {
  ...
  TooltipContent,
  TooltipTrigger,
} from "@spotting/ui/components/ui/tooltip"
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 md:peer-data-[variant=inset]:overflow-hidden relative flex w-full flex-1 flex-col",
        className
      )}
      {...props}
    />
